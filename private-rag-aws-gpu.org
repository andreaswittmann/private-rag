...
tail -n 25 docker/docker-compose.yml
   
# Fix executor bug in docker-compose.yml, calling wrong entrypoint script
perl -i -pe 's{entrypoint: "/ragflow/entrypoint_task_executor.sh 1 3"}{entrypoint: "/ragflow/entrypoint.sh --disable-webserver --workers=2"}g' docker/docker-compose.yml
cat docker/docker-compose.yml | grep entrypoint
